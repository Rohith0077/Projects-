...
# Apply predicate pushdown to filter specific regions
...
# Resolve choice types and drop null fields
resolvechoice2 = ResolveChoice.apply(frame=applymapping1, choice="make_struct", transformation_ctx="resolvechoice2")
dropnullfields3 = DropNullFields.apply(frame=resolvechoice2, transformation_ctx="dropnullfields3")

# Convert to DataFrame and optimize file output
datasink1 = dropnullfields3.toDF().coalesce(1)
df_final_output = DynamicFrame.fromDF(datasink1, glueContext, "df_final_output")

# Write the transformed data back to S3 in Parquet format with partitioning
